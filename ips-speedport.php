...
class SpeedportHybrid extends speedport{ 
    ...
    public function __construct($password, $url = "http://speedport.ip", $debug = true, $variable_profile_prefix = "Speedport_", $call_sort = SORT_DESC, $parentId = "", $fw_update_interval = 43200){ 
